...
write_to = "image_processing_service/_version.py"
```
...
description = "imag eprocessign service using python"
authors = [{"name" = "brianlee"}]
...
ls dist/
# image_processing_service-1.2.3.tar.gz
# image_processing_service-1.2.3-py3-none-any.whl
```
...
# Install from wheel
pip install dist/image_processing_service-*.whl

# Verify installation
python -c "import image_processing_service; print(image_processing_service.__version__)"
...
3. Fill in the form:
   - **PyPI Project Name**: `image_processing_service`
...
1. Go to your project page: `https://pypi.org/project/image_processing_service/`
...
```bash
# View on PyPI
open https://pypi.org/project/image_processing_service/

# Install from PyPI
pip install image_processing_service
...
ls image_processing_service/_version.py
```
