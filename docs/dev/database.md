...
Models are defined in the `image_processing_service/models` directory and inherit from the declarative base.
...
from image_processing_service.models.base import Base
...
```python
from image_processing_service.services.db import get_session
...
python -m image_processing_service.www  # or celery, etc.
```
