...
- **`image_processing_service/conf/settings.py`**: Main Settings class
- **`image_processing_service/conf/db.py`**: Database settings
- **`image_processing_service/settings.py`**: Global settings instance
...
```python
from image_processing_service.conf import settings
...
```python
# image_processing_service/conf/settings.py
...
class Settings(BaseSettings):
    # Application
    project_name: str = "image_processing_service"
    version: str = "0.1.0"
    debug: bool = False
...
```python
from image_processing_service.conf.cache import CacheSettings
