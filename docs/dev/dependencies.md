...
- Installed with `pip install image_processing_service`
...
- Installed with `pip install image_processing_service[dev]`
...
# Or from PyPI
uv pip install image_processing_service
...
# Creates:
# dist/image_processing_service-X.Y.Z.tar.gz (source)
# dist/image_processing_service-X.Y.Z-py3-none-any.whl (wheel)
```
